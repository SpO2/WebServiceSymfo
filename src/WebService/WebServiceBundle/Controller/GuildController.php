...
class GuildController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebServiceWebServiceBundle:Guild')->findAll();
     ...
     * @Method("POST")
     * @Template("WebServiceWebServiceBundle:Guild:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebServiceWebServiceBundle:Guild')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WebServiceWebServiceBundle:Guild:edit.html.twig")
     */
