...
class BootController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebServiceWebServiceBundle:Boot')->findAll();
     ...
     * @Method("POST")
     * @Template("WebServiceWebServiceBundle:Boot:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebServiceWebServiceBundle:Boot')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WebServiceWebServiceBundle:Boot:edit.html.twig")
     */
