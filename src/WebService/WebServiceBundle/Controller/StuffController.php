...
use WebService\WebServiceBundle\Entity\Stuff;
...
class StuffController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebServiceWebServiceBundle:Stuff')->findAll();
     ...
     * @Method("POST")
     * @Template("WebServiceWebServiceBundle:Stuff:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebServiceWebServiceBundle:Stuff')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WebServiceWebServiceBundle:Stuff:edit.html.twig")
     */
