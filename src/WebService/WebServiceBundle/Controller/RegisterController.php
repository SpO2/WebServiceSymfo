...
class RegisterController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebServiceWebServiceBundle:Register')->findAll();
     ...
     * @Method("POST")
     * @Template("WebServiceWebServiceBundle:Register:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebServiceWebServiceBundle:Register')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WebServiceWebServiceBundle:Register:edit.html.twig")
     */
