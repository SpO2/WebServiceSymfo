...
use WebService\WebServiceBundle\Form\HelmetType;
...
class HelmetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebServiceWebServiceBundle:Helmet')->findAll();
     ...
     * @Method("POST")
     * @Template("WebServiceWebServiceBundle:Helmet:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebServiceWebServiceBundle:Helmet')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WebServiceWebServiceBundle:Helmet:edit.html.twig")
     */
